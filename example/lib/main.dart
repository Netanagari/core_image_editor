...
class _MyHomePageState extends State<MyHomePage> {
  ...
  @override
  void initState() {
    // final x = File('assets/all_ids.json').readAsStringSync();
    // ids = jsonDecode(x) as List<int>;
    super.initState();
  }
    ...
    return Scaffold(
      body: Center(
        child: BulkPosterProcessorWidget(
          ...
          posterIds: ids,
          // posterIds: [1842, 1890, 1940, 1975, 1990, 2056],
          concurrentTasks: 100,
          apiBaseUrl: "https://netanagri.co.in/api",
        ),
      ),
    );
  }
